  ...
  return (
    <div className='karshenasi' >
       ...
       <div className='questionRowKar'>
          ...
          <div className='verticalCrKar'>
            ...
            <div className='sliderRowNazarat'>
              ...
              <Carousel className='sliderCompo'
                  ...
                  renderPagination={({ pages, activePage, onClick }) => {
                    return (
                      <div className='paginationRowSlider3'>
                        {
                        pages.map(page => {
                          const isActivePage = activePage === page
                          return (
        ...
        <div style={{margin:'40px auto',padding:'30px 0px',width:'600px',height:res650 ? '100px': res800? '160px': res1000? '220px':'300px',backgroundColor:''}}>
