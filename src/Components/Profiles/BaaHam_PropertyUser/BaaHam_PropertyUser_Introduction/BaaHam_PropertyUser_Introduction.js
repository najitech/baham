...
import './BaaHam_PropertyUser_Introduction.css'
import BaaHam_PU_IntroductionTable from './BaaHam_PU_IntroductionTable'

function BaaHam_PropertyUser_Introduction() {
    let Tables = [ 
        {
            TableNumber : 1,
            FirstName : "محمد",
  ...
  return (
    <div className='BaaHam_MarketerUser_Introduction'>
        ...
        <div className='BaaHam_MU_IntroductionTables'>
            <BaaHam_PU_IntroductionTable TableNumber={1} Tables={Tables}/>
...
export default BaaHam_PropertyUser_Introduction