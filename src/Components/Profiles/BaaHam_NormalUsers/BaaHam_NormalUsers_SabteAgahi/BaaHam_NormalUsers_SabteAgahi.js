...
import './BaaHam_NormalUsers_SabteAgahi.css'
import SabteAgahi_DropDown from './SabteAgahi_DropDown'
...
const customStyles = {
  ...
  return (
    <div className='BaaHam_NormalUsers_SabteAgahi' id="scroller">
...
export default BaaHam_NormalUsers_SabteAgahi