...
import './BaaHam_VisitingExpertUser_Profile.css'

function BaaHam_VisitingExpertUser_Profile() {
  return (
    <div className='BaaHam_VisitingExpertUser_Profile'>
...
export default BaaHam_VisitingExpertUser_Profile